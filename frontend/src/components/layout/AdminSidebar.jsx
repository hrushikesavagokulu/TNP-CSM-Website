...
const ADMIN_NAV_ITEMS = [
  ...
  { path: '/admin/roadmap', label: 'Skill Roadmap', icon: 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7' },
  ...
  { path: '/admin/alumni', label: 'Alumni Repos', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.168.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
  { path: '/admin/achievements', label: 'Achievements', icon: 'M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.286L13 21l-2.286-6.857L5 12l5.714-2.286L13 3z' },
  { path: '/admin/learning', label: 'Resources', icon: 'M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z' },
  { path: '/admin/resume', label: 'Resume Guide', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  { path: '/admin/chat', label: 'Connect Sphere', icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
  { path: '/admin/dept-info', label: 'Department Info', icon: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
];
      ...
      >
        <div className="flex-1 overflow-y-auto px-4 py-6 scrollbar-thin">
          ...
          <div className="px-4 mb-4 flex items-center gap-2">
            ...
            <span className="text-[10px] font-black text-red-400 uppercase tracking-widest">Admin Control</span>
          </div>
                ...
                <NavLink
                  ...
                  className={({ isActive }) => `
                    ...
                    ${isActive
                      ...
                      : 'text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] hover:bg-red-500/10'}
                  `}
                >
                  {({ isActive }) => (
                    <>
                      <svg
                        className={`w-5 h-5 flex-shrink-0 transition-colors duration-150 ${
                          isActive ? 'text-white' : 'text-[var(--color-text-muted)] group-hover:text-red-400'
                        }`}
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
